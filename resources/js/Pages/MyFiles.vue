<template>
    <AuthenticatedLayout>
       <nav class="flex items-center justify-between p-1 mb-3">
        ...
        <div>
            <AddToFavouritesButton :allSelected="allSelected" :selectedIds="selectedIds"  />
            ...
            <tbody>
                <tr v-for="file, idx of allFiles.data" :key="file.id" class="bg-white border-b transition duration-300 ease-in-out hover:bg-blue-100 cursor-pointer"
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-yellow-500">
                        ...
                        <svg v-if="file.is_favourite" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
